...
export interface AppClientDeployCallInterfaceParams {
	...
	createOnCompleteAction?:
		| Exclude<AppCallType, 'clear_state'>
		| Exclude<OnApplicationComplete, OnApplicationComplete.ClearStateOC>;
...
export declare class ApplicationClient {
	 ...
	 */
	deploy(deploy?: AppClientDeployParams): Promise<
	...
	callOfType(
		...
		callType:
			| Exclude<AppCallType, 'update_application'>
