import type { DeflyWalletDetails, DeflyWalletPlatformType } from "../deflyWalletTypes";
...
function getWalletConnectObjectFromStorage() {
  ...
  if (storedWalletConnectObject) {
    return JSON.parse(storedWalletConnectObject);
  }
