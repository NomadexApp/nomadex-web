...
export type AlgoArc200PoolV02 = {
	...
	> &
		...
		> &
		Record<
			'poolInitialize(byte[32],byte[8],application)void' | 'poolInitialize',
			{
				argsObj: {
					/**
		...
		> &
		Record<
			'setFeeController(address)bool' | 'setFeeController',
			{
				argsObj: {
					/**
		...
		> &
		Record<
			'setPlatformFees(uint256)bool' | 'setPlatformFees',
			{
				argsObj: {
					/**
		...
		> &
		Record<
			'addLiquidity(pay,uint256)bool' | 'addLiquidity',
			{
				argsObj: {
					/**
					 * x-token txn
		...
		> &
		Record<
			'removeLiquidity(uint256)bool' | 'removeLiquidity',
			{
				argsObj: {
					/**
		...
		> &
		Record<
			'swapXtoY(pay,uint256)uint256' | 'swapXtoY',
			{
				argsObj: {
					/**
					 * x-token pay txn
		...
		> &
		Record<
			'swapYtoX(uint256,uint256)uint256' | 'swapYtoX',
			{
				argsObj: {
					/**
 ...
 */
export type MethodArgs<TSignature extends AlgoArc200PoolV02Sig> = AlgoArc200PoolV02['methods'][TSignature][
	| 'argsObj'
	| 'argsTuple'];
/**
 ...
 */
export type AlgoArc200PoolV02CreateCallParams = TypedCallParams<'createApplication(address)void'> & OnCompleteNoOp;
/**
 ...
 */
export type AlgoArc200PoolV02UpdateCallParams = TypedCallParams<'updateApplication()void'>;
/**
 ...
 */
export type AlgoArc200PoolV02DeleteCallParams = TypedCallParams<'deleteApplication()void'>;
/**
...
export abstract class AlgoArc200PoolV02CallFactory {
	 ...
	 * @returns A TypedCallParams object for the call
	 */
	static poolInitialize(
		args: MethodArgs<'poolInitialize(byte[32],byte[8],application)void'>,
		params: AppClientCallCoreParams & CoreAppCallArgs
	) {
		return {
	 ...
	 * @returns A TypedCallParams object for the call
	 */
	static setFeeController(
		args: MethodArgs<'setFeeController(address)bool'>,
		params: AppClientCallCoreParams & CoreAppCallArgs
	) {
		return {
	 ...
	 * @returns A TypedCallParams object for the call
	 */
	static setPlatformFees(
		args: MethodArgs<'setPlatformFees(uint256)bool'>,
		params: AppClientCallCoreParams & CoreAppCallArgs
	) {
		return {
	...
	static registerOnline(
		...
		return {
			...
			methodArgs: Array.isArray(args)
				? args
				: [args.selectionPk, args.stateProofPk, args.votePk, args.voteFirst, args.voteLast, args.voteKeyDilution],
			...params,
		};
	}
	/**
	 ...
	 */
	static addLiquidity(
		args: MethodArgs<'addLiquidity(pay,uint256)bool'>,
		params: AppClientCallCoreParams & CoreAppCallArgs
	) {
		return {
	...
	static removeLiquidity(
		args: MethodArgs<'removeLiquidity(uint256)bool'>,
		params: AppClientCallCoreParams & CoreAppCallArgs
	) {
		return {
	 ...
	 */
	static swapYtoX(
		args: MethodArgs<'swapYtoX(uint256,uint256)uint256'>,
		params: AppClientCallCoreParams & CoreAppCallArgs
	) {
		return {
...
export class AlgoArc200PoolV02Client {
	 ...
	 */
	public async call<TSignature extends keyof AlgoArc200PoolV02['methods']>(
	 ...
	 */
	public deploy(
		params: AlgoArc200PoolV02DeployArgs & AppClientDeployCoreParams = {}
		...
		return {
			...
			async createApplication(
				...
				return $this.mapReturnValue(
					await $this.appClient.create(AlgoArc200PoolV02CallFactory.create.createApplication(args, params))
				);
			},
		};
	}
	...
	public get update() {
		...
		return {
			...
			async updateApplication(
				...
				return $this.mapReturnValue(
					await $this.appClient.update(AlgoArc200PoolV02CallFactory.update.updateApplication(args, params))
				);
			},
		};
	}
	...
	public get delete() {
		...
		return {
			...
			async deleteApplication(
				...
				return $this.mapReturnValue(
					await $this.appClient.delete(AlgoArc200PoolV02CallFactory.delete.deleteApplication(args, params))
				);
			},
		};
	}
	 ...
	 */
	public swapXtoY(
		args: MethodArgs<'swapXtoY(pay,uint256)uint256'>,
		params: AppClientCallCoreParams & CoreAppCallArgs = {}
	) {
	...
	public compose(): AlgoArc200PoolV02Composer {
		...
		return {
			...
			poolInitialize(
				...
				promiseChain = promiseChain.then(() =>
					client.poolInitialize(args, { ...params, sendParams: { ...params?.sendParams, skipSending: true, atc } })
				);
				resultMappers.push(undefined);
				return this;
			},
			setFeeController(
				...
				promiseChain = promiseChain.then(() =>
					client.setFeeController(args, { ...params, sendParams: { ...params?.sendParams, skipSending: true, atc } })
				);
				resultMappers.push(undefined);
				return this;
			},
			...
			setPlatformFees(
				...
				promiseChain = promiseChain.then(() =>
					client.setPlatformFees(args, { ...params, sendParams: { ...params?.sendParams, skipSending: true, atc } })
				);
				resultMappers.push(undefined);
				return this;
			},
			...
			getRatio(args: MethodArgs<'getRatio()uint256'>, params?: AppClientCallCoreParams & CoreAppCallArgs) {
				promiseChain = promiseChain.then(() =>
					client.getRatio(args, { ...params, sendParams: { ...params?.sendParams, skipSending: true, atc } })
				);
				resultMappers.push(undefined);
				return this;
			},
			addLiquidity(
				...
				promiseChain = promiseChain.then(() =>
					client.addLiquidity(args, { ...params, sendParams: { ...params?.sendParams, skipSending: true, atc } })
				);
				resultMappers.push(undefined);
				return this;
			},
			removeLiquidity(
				...
				promiseChain = promiseChain.then(() =>
					client.removeLiquidity(args, { ...params, sendParams: { ...params?.sendParams, skipSending: true, atc } })
				);
				resultMappers.push(undefined);
				return this;
			},
			swapXtoY(args: MethodArgs<'swapXtoY(pay,uint256)uint256'>, params?: AppClientCallCoreParams & CoreAppCallArgs) {
				promiseChain = promiseChain.then(() =>
					client.swapXtoY(args, { ...params, sendParams: { ...params?.sendParams, skipSending: true, atc } })
				);
				resultMappers.push(undefined);
				return this;
			},
			swapYtoX(
				...
				promiseChain = promiseChain.then(() =>
					client.swapYtoX(args, { ...params, sendParams: { ...params?.sendParams, skipSending: true, atc } })
				);
				resultMappers.push(undefined);
				return this;
			},
...
export type AlgoArc200PoolV02Composer<TReturns extends [...any[]] = []> = {
	...
	setManager(
		args: MethodArgs<'setManager(address)bool'>,
		params?: AppClientCallCoreParams & CoreAppCallArgs
	): AlgoArc200PoolV02Composer<[...TReturns, MethodReturn<'setManager(address)bool'>]>;
	...
	initialize(
		args: MethodArgs<'initialize(byte[32],byte[8],uint8,uint256,address)void'>,
		params?: AppClientCallCoreParams & CoreAppCallArgs
	): AlgoArc200PoolV02Composer<[...TReturns, MethodReturn<'initialize(byte[32],byte[8],uint8,uint256,address)void'>]>;
	...
	arc200Name(
		...
		params?: AppClientCallCoreParams & CoreAppCallArgs
	): AlgoArc200PoolV02Composer<[...TReturns, MethodReturn<'arc200_name()byte[32]'>]>;
	...
	arc200Symbol(
		args: MethodArgs<'arc200_symbol()byte[8]'>,
		params?: AppClientCallCoreParams & CoreAppCallArgs
	): AlgoArc200PoolV02Composer<[...TReturns, MethodReturn<'arc200_symbol()byte[8]'>]>;
	...
	arc200Decimals(
		args: MethodArgs<'arc200_decimals()uint8'>,
		params?: AppClientCallCoreParams & CoreAppCallArgs
	): AlgoArc200PoolV02Composer<[...TReturns, MethodReturn<'arc200_decimals()uint8'>]>;
	...
	arc200TotalSupply(
		args: MethodArgs<'arc200_totalSupply()uint256'>,
		params?: AppClientCallCoreParams & CoreAppCallArgs
	): AlgoArc200PoolV02Composer<[...TReturns, MethodReturn<'arc200_totalSupply()uint256'>]>;
	...
	arc200BalanceOf(
		args: MethodArgs<'arc200_balanceOf(address)uint256'>,
		params?: AppClientCallCoreParams & CoreAppCallArgs
	): AlgoArc200PoolV02Composer<[...TReturns, MethodReturn<'arc200_balanceOf(address)uint256'>]>;
	...
	hasBalance(
		args: MethodArgs<'hasBalance(address)bool'>,
		params?: AppClientCallCoreParams & CoreAppCallArgs
	): AlgoArc200PoolV02Composer<[...TReturns, MethodReturn<'hasBalance(address)bool'>]>;
	...
	hasAllowance(
		args: MethodArgs<'hasAllowance(address,address)bool'>,
		params?: AppClientCallCoreParams & CoreAppCallArgs
	): AlgoArc200PoolV02Composer<[...TReturns, MethodReturn<'hasAllowance(address,address)bool'>]>;
	...
	arc200Allowance(
		args: MethodArgs<'arc200_allowance(address,address)uint256'>,
		params?: AppClientCallCoreParams & CoreAppCallArgs
	): AlgoArc200PoolV02Composer<[...TReturns, MethodReturn<'arc200_allowance(address,address)uint256'>]>;
	...
	arc200Transfer(
		args: MethodArgs<'arc200_transfer(address,uint256)bool'>,
		params?: AppClientCallCoreParams & CoreAppCallArgs
	): AlgoArc200PoolV02Composer<[...TReturns, MethodReturn<'arc200_transfer(address,uint256)bool'>]>;
	...
	arc200Approve(
		args: MethodArgs<'arc200_approve(address,uint256)bool'>,
		params?: AppClientCallCoreParams & CoreAppCallArgs
	): AlgoArc200PoolV02Composer<[...TReturns, MethodReturn<'arc200_approve(address,uint256)bool'>]>;
	...
	arc200TransferFrom(
		args: MethodArgs<'arc200_transferFrom(address,address,uint256)bool'>,
		params?: AppClientCallCoreParams & CoreAppCallArgs
	): AlgoArc200PoolV02Composer<[...TReturns, MethodReturn<'arc200_transferFrom(address,address,uint256)bool'>]>;
	...
	poolInitialize(
		args: MethodArgs<'poolInitialize(byte[32],byte[8],application)void'>,
		params?: AppClientCallCoreParams & CoreAppCallArgs
	): AlgoArc200PoolV02Composer<[...TReturns, MethodReturn<'poolInitialize(byte[32],byte[8],application)void'>]>;
	...
	setFeeController(
		args: MethodArgs<'setFeeController(address)bool'>,
		params?: AppClientCallCoreParams & CoreAppCallArgs
	): AlgoArc200PoolV02Composer<[...TReturns, MethodReturn<'setFeeController(address)bool'>]>;
	 ...
	 */
	setFees(
		args: MethodArgs<'setFees(uint256)bool'>,
		params?: AppClientCallCoreParams & CoreAppCallArgs
	): AlgoArc200PoolV02Composer<[...TReturns, MethodReturn<'setFees(uint256)bool'>]>;
	...
	setPlatformFees(
		args: MethodArgs<'setPlatformFees(uint256)bool'>,
		params?: AppClientCallCoreParams & CoreAppCallArgs
	): AlgoArc200PoolV02Composer<[...TReturns, MethodReturn<'setPlatformFees(uint256)bool'>]>;
	...
	registerOffline(
		args: MethodArgs<'registerOffline()void'>,
		params?: AppClientCallCoreParams & CoreAppCallArgs
	): AlgoArc200PoolV02Composer<[...TReturns, MethodReturn<'registerOffline()void'>]>;
	 ...
	 */
	getRatio(
		args: MethodArgs<'getRatio()uint256'>,
		params?: AppClientCallCoreParams & CoreAppCallArgs
	): AlgoArc200PoolV02Composer<[...TReturns, MethodReturn<'getRatio()uint256'>]>;
	...
	addLiquidity(
		args: MethodArgs<'addLiquidity(pay,uint256)bool'>,
		params?: AppClientCallCoreParams & CoreAppCallArgs
	): AlgoArc200PoolV02Composer<[...TReturns, MethodReturn<'addLiquidity(pay,uint256)bool'>]>;
	...
	removeLiquidity(
		args: MethodArgs<'removeLiquidity(uint256)bool'>,
		params?: AppClientCallCoreParams & CoreAppCallArgs
	): AlgoArc200PoolV02Composer<[...TReturns, MethodReturn<'removeLiquidity(uint256)bool'>]>;
	...
	swapXtoY(
		args: MethodArgs<'swapXtoY(pay,uint256)uint256'>,
		params?: AppClientCallCoreParams & CoreAppCallArgs
	): AlgoArc200PoolV02Composer<[...TReturns, MethodReturn<'swapXtoY(pay,uint256)uint256'>]>;
	...
	swapYtoX(
		args: MethodArgs<'swapYtoX(uint256,uint256)uint256'>,
		params?: AppClientCallCoreParams & CoreAppCallArgs
	): AlgoArc200PoolV02Composer<[...TReturns, MethodReturn<'swapYtoX(uint256,uint256)uint256'>]>;
	...
	readonly update: {
		...
		updateApplication(
			args: MethodArgs<'updateApplication()void'>,
			params?: AppClientCallCoreParams & AppClientCompilationParams
		): AlgoArc200PoolV02Composer<[...TReturns, MethodReturn<'updateApplication()void'>]>;
	};
	...
	readonly delete: {
		...
		deleteApplication(
			args: MethodArgs<'deleteApplication()void'>,
			params?: AppClientCallCoreParams
		): AlgoArc200PoolV02Composer<[...TReturns, MethodReturn<'deleteApplication()void'>]>;
	};
	...
	): AlgoArc200PoolV02Composer<[...TReturns, undefined]>;
	...
	addTransaction(
		txn: TransactionWithSigner | TransactionToSign | Transaction | Promise<SendTransactionResult>,
		defaultSender?: SendTransactionFrom
	): AlgoArc200PoolV02Composer<TReturns>;
	/**
