...
export type Arc200Token = {
	 ...
	 */
	methods: Record<
		'createApplication(address)void' | 'createApplication',
		{
			argsObj: {
				manager: string;
			};
	...
	> &
		...
		> &
		Record<
			'setManager(address)bool' | 'setManager',
			{
				argsObj: {
					manager: string;
				};
		...
		> &
		Record<
			'initialize(byte[32],byte[8],uint8,uint256,address)void' | 'initialize',
			{
				argsObj: {
					/**
					 * token name
		...
		> &
		Record<
			'hasBalance(address)bool' | 'hasBalance',
			{
				argsObj: {
					/**
		...
		> &
		Record<
			'hasAllowance(address,address)bool' | 'hasAllowance',
			{
				argsObj: {
					/**
					 * The address of the owner
 ...
 */
export type Arc200TokenCreateCallParams = TypedCallParams<'createApplication(address)void'> & OnCompleteNoOp;
/**
 ...
 */
export type Arc200TokenUpdateCallParams = TypedCallParams<'updateApplication()void'>;
/**
 ...
 */
export type Arc200TokenDeleteCallParams = TypedCallParams<'deleteApplication()void'>;
/**
...
export abstract class Arc200TokenCallFactory {
	...
	static get create() {
		return {
			 ...
			 */
			createApplication(
				args: MethodArgs<'createApplication(address)void'>,
	 ...
	 */
	static initialize(
		args: MethodArgs<'initialize(byte[32],byte[8],uint8,uint256,address)void'>,
		params: AppClientCallCoreParams & CoreAppCallArgs
	) {
		return {
	...
	static arc200TotalSupply(
		args: MethodArgs<'arc200_totalSupply()uint256'>,
		params: AppClientCallCoreParams & CoreAppCallArgs
	) {
		return {
	...
	static arc200BalanceOf(
		args: MethodArgs<'arc200_balanceOf(address)uint256'>,
		params: AppClientCallCoreParams & CoreAppCallArgs
	) {
		return {
	 ...
	 */
	static hasAllowance(
		args: MethodArgs<'hasAllowance(address,address)bool'>,
		params: AppClientCallCoreParams & CoreAppCallArgs
	) {
		return {
	...
	static arc200Allowance(
		args: MethodArgs<'arc200_allowance(address,address)uint256'>,
		params: AppClientCallCoreParams & CoreAppCallArgs
	) {
		return {
	...
	static arc200Transfer(
		args: MethodArgs<'arc200_transfer(address,uint256)bool'>,
		params: AppClientCallCoreParams & CoreAppCallArgs
	) {
		return {
	...
	static arc200Approve(
		args: MethodArgs<'arc200_approve(address,uint256)bool'>,
		params: AppClientCallCoreParams & CoreAppCallArgs
	) {
		return {
	...
	static arc200TransferFrom(
		args: MethodArgs<'arc200_transferFrom(address,address,uint256)bool'>,
		params: AppClientCallCoreParams & CoreAppCallArgs
	) {
		return {
...
export class Arc200TokenClient {
	 ...
	 */
	public async call<TSignature extends keyof Arc200Token['methods']>(
	 ...
	 */
	public deploy(
		params: Arc200TokenDeployArgs & AppClientDeployCoreParams = {}
	...
	public get create() {
		...
		return {
			...
			): Promise<AppCallTransactionResultOfType<MethodReturn<'createApplication(address)void'>>> {
				return $this.mapReturnValue(
					await $this.appClient.create(Arc200TokenCallFactory.create.createApplication(args, params))
				);
			},
		};
	}
	...
	public get update() {
		...
		return {
			...
			async updateApplication(
				...
				return $this.mapReturnValue(
					await $this.appClient.update(Arc200TokenCallFactory.update.updateApplication(args, params))
				);
			},
		};
	}
	...
	public get delete() {
		...
		return {
			...
			): Promise<AppCallTransactionResultOfType<MethodReturn<'deleteApplication()void'>>> {
				return $this.mapReturnValue(
					await $this.appClient.delete(Arc200TokenCallFactory.delete.deleteApplication(args, params))
				);
			},
		};
	}
	 ...
	 */
	public setManager(
		args: MethodArgs<'setManager(address)bool'>,
		params: AppClientCallCoreParams & CoreAppCallArgs = {}
	) {
	 ...
	 */
	public arc200Symbol(
		args: MethodArgs<'arc200_symbol()byte[8]'>,
		params: AppClientCallCoreParams & CoreAppCallArgs = {}
	) {
	 ...
	 */
	public arc200Decimals(
		args: MethodArgs<'arc200_decimals()uint8'>,
		params: AppClientCallCoreParams & CoreAppCallArgs = {}
	) {
	 ...
	 */
	public hasBalance(
		args: MethodArgs<'hasBalance(address)bool'>,
		params: AppClientCallCoreParams & CoreAppCallArgs = {}
	) {
		...
		return {
			setManager(args: MethodArgs<'setManager(address)bool'>, params?: AppClientCallCoreParams & CoreAppCallArgs) {
				promiseChain = promiseChain.then(() =>
					client.setManager(args, { ...params, sendParams: { ...params?.sendParams, skipSending: true, atc } })
				);
			...
			initialize(
				...
				promiseChain = promiseChain.then(() =>
					client.initialize(args, { ...params, sendParams: { ...params?.sendParams, skipSending: true, atc } })
				);
				resultMappers.push(undefined);
				return this;
			},
			arc200Name(args: MethodArgs<'arc200_name()byte[32]'>, params?: AppClientCallCoreParams & CoreAppCallArgs) {
				promiseChain = promiseChain.then(() =>
					client.arc200Name(args, { ...params, sendParams: { ...params?.sendParams, skipSending: true, atc } })
				);
				resultMappers.push(undefined);
				return this;
			},
			arc200Symbol(args: MethodArgs<'arc200_symbol()byte[8]'>, params?: AppClientCallCoreParams & CoreAppCallArgs) {
				promiseChain = promiseChain.then(() =>
					client.arc200Symbol(args, { ...params, sendParams: { ...params?.sendParams, skipSending: true, atc } })
				);
				resultMappers.push(undefined);
				return this;
			},
			arc200Decimals(args: MethodArgs<'arc200_decimals()uint8'>, params?: AppClientCallCoreParams & CoreAppCallArgs) {
				promiseChain = promiseChain.then(() =>
					client.arc200Decimals(args, { ...params, sendParams: { ...params?.sendParams, skipSending: true, atc } })
				);
				resultMappers.push(undefined);
				return this;
			},
			arc200TotalSupply(
				...
				promiseChain = promiseChain.then(() =>
					client.arc200TotalSupply(args, { ...params, sendParams: { ...params?.sendParams, skipSending: true, atc } })
				);
				resultMappers.push(undefined);
				return this;
			},
			arc200BalanceOf(
				...
				promiseChain = promiseChain.then(() =>
					client.arc200BalanceOf(args, { ...params, sendParams: { ...params?.sendParams, skipSending: true, atc } })
				);
				resultMappers.push(undefined);
				return this;
			},
			hasBalance(args: MethodArgs<'hasBalance(address)bool'>, params?: AppClientCallCoreParams & CoreAppCallArgs) {
				promiseChain = promiseChain.then(() =>
					client.hasBalance(args, { ...params, sendParams: { ...params?.sendParams, skipSending: true, atc } })
				);
				resultMappers.push(undefined);
				return this;
			},
			hasAllowance(
				...
				promiseChain = promiseChain.then(() =>
					client.hasAllowance(args, { ...params, sendParams: { ...params?.sendParams, skipSending: true, atc } })
				);
				resultMappers.push(undefined);
				return this;
			},
			arc200Allowance(
				...
				promiseChain = promiseChain.then(() =>
					client.arc200Allowance(args, { ...params, sendParams: { ...params?.sendParams, skipSending: true, atc } })
				);
				resultMappers.push(undefined);
				return this;
			},
			arc200Transfer(
				...
				promiseChain = promiseChain.then(() =>
					client.arc200Transfer(args, { ...params, sendParams: { ...params?.sendParams, skipSending: true, atc } })
				);
				resultMappers.push(undefined);
				return this;
			},
			arc200Approve(
				...
				promiseChain = promiseChain.then(() =>
					client.arc200Approve(args, { ...params, sendParams: { ...params?.sendParams, skipSending: true, atc } })
				);
				resultMappers.push(undefined);
				return this;
			},
			arc200TransferFrom(
				...
				promiseChain = promiseChain.then(() =>
					client.arc200TransferFrom(args, { ...params, sendParams: { ...params?.sendParams, skipSending: true, atc } })
				);
				resultMappers.push(undefined);
				return this;
			},
...
export type Arc200TokenComposer<TReturns extends [...any[]] = []> = {
	...
	setManager(
		args: MethodArgs<'setManager(address)bool'>,
		params?: AppClientCallCoreParams & CoreAppCallArgs
	): Arc200TokenComposer<[...TReturns, MethodReturn<'setManager(address)bool'>]>;
	...
	initialize(
		args: MethodArgs<'initialize(byte[32],byte[8],uint8,uint256,address)void'>,
		params?: AppClientCallCoreParams & CoreAppCallArgs
	): Arc200TokenComposer<[...TReturns, MethodReturn<'initialize(byte[32],byte[8],uint8,uint256,address)void'>]>;
	 ...
	 */
	arc200Name(
		args: MethodArgs<'arc200_name()byte[32]'>,
		params?: AppClientCallCoreParams & CoreAppCallArgs
	): Arc200TokenComposer<[...TReturns, MethodReturn<'arc200_name()byte[32]'>]>;
	...
	arc200Symbol(
		args: MethodArgs<'arc200_symbol()byte[8]'>,
		params?: AppClientCallCoreParams & CoreAppCallArgs
	): Arc200TokenComposer<[...TReturns, MethodReturn<'arc200_symbol()byte[8]'>]>;
	...
	arc200Decimals(
		args: MethodArgs<'arc200_decimals()uint8'>,
		params?: AppClientCallCoreParams & CoreAppCallArgs
	): Arc200TokenComposer<[...TReturns, MethodReturn<'arc200_decimals()uint8'>]>;
	...
	arc200TotalSupply(
		args: MethodArgs<'arc200_totalSupply()uint256'>,
		params?: AppClientCallCoreParams & CoreAppCallArgs
	): Arc200TokenComposer<[...TReturns, MethodReturn<'arc200_totalSupply()uint256'>]>;
	...
	arc200BalanceOf(
		args: MethodArgs<'arc200_balanceOf(address)uint256'>,
		params?: AppClientCallCoreParams & CoreAppCallArgs
	): Arc200TokenComposer<[...TReturns, MethodReturn<'arc200_balanceOf(address)uint256'>]>;
	...
	hasBalance(
		args: MethodArgs<'hasBalance(address)bool'>,
		params?: AppClientCallCoreParams & CoreAppCallArgs
	): Arc200TokenComposer<[...TReturns, MethodReturn<'hasBalance(address)bool'>]>;
	...
	hasAllowance(
		args: MethodArgs<'hasAllowance(address,address)bool'>,
		params?: AppClientCallCoreParams & CoreAppCallArgs
	): Arc200TokenComposer<[...TReturns, MethodReturn<'hasAllowance(address,address)bool'>]>;
	...
	arc200Allowance(
		args: MethodArgs<'arc200_allowance(address,address)uint256'>,
		params?: AppClientCallCoreParams & CoreAppCallArgs
	): Arc200TokenComposer<[...TReturns, MethodReturn<'arc200_allowance(address,address)uint256'>]>;
	...
	arc200Transfer(
		args: MethodArgs<'arc200_transfer(address,uint256)bool'>,
		params?: AppClientCallCoreParams & CoreAppCallArgs
	): Arc200TokenComposer<[...TReturns, MethodReturn<'arc200_transfer(address,uint256)bool'>]>;
	...
	arc200Approve(
		args: MethodArgs<'arc200_approve(address,uint256)bool'>,
		params?: AppClientCallCoreParams & CoreAppCallArgs
	): Arc200TokenComposer<[...TReturns, MethodReturn<'arc200_approve(address,uint256)bool'>]>;
	...
	arc200TransferFrom(
		args: MethodArgs<'arc200_transferFrom(address,address,uint256)bool'>,
		params?: AppClientCallCoreParams & CoreAppCallArgs
	): Arc200TokenComposer<[...TReturns, MethodReturn<'arc200_transferFrom(address,address,uint256)bool'>]>;
	...
	readonly update: {
		...
		updateApplication(
			args: MethodArgs<'updateApplication()void'>,
			params?: AppClientCallCoreParams & AppClientCompilationParams
		): Arc200TokenComposer<[...TReturns, MethodReturn<'updateApplication()void'>]>;
	};
	...
	readonly delete: {
		...
		deleteApplication(
			args: MethodArgs<'deleteApplication()void'>,
			params?: AppClientCallCoreParams
		): Arc200TokenComposer<[...TReturns, MethodReturn<'deleteApplication()void'>]>;
	};
	...
	): Arc200TokenComposer<[...TReturns, undefined]>;
